...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "oKQcJKSiUE1sc3osFjArBcy5D", consumerSecret: "8ZIcLgKAevCrUP3uSL0OUVbsKxzHlxMN99TQfNT9YzPweEBBiT")
    var loginSuccess: (() -> ())?
